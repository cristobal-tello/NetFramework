...
<body>
    <form id="Form1" runat="server">
        ...
        <div>
             <asp:Timer ID="Timer1" Interval="1000" OnTick="Timer1_Tick"  runat="server"></asp:Timer>      <%--If timer is outside UpdatePanel, full request postback will be done--%>
                                                                                                                            <%--Use <Triggers> </Triggers> to wire up with UpdatePanel--%>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlId="Timer1" EventName="Tick" />        <%--If you remove this line, a full post-back will be fired--%>
                </Triggers>
            </asp:UpdatePanel>
        </div>
